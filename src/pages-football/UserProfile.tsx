...
import { Card, CardContent, CardHeader, CardTitle, Button, Badge } from '../components-football/ui';
import { format } from 'date-fns';
import { User, Mail, Globe, FileText, Bell, Shield, Crown, CheckCircle2, XCircle, CreditCard as Edit3, Save, X, Camera, Lock } from 'lucide-react';
import { MOCK_RESULTS } from '../data-football/mockData';
