...
import { UserProfile, calculateLevelAndRank, AVATAR_OPTIONS } from "../types-snakes/profile";
import { PLAYER_COLORS } from "../game-snakes/constants";
import { createNewUser } from "../utils-snakes/storage";
